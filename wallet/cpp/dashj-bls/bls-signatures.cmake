...
set(BLS_VENDOR_ROOT ${CMAKE_CURRENT_SOURCE_DIR}/bls-signatures)
set(BLS_RELIC_RELATIVE_DIR "depends/relic")
if (NOT EXISTS "${BLS_VENDOR_ROOT}/${BLS_RELIC_RELATIVE_DIR}/CMakeLists.txt")
    set(BLS_RELIC_RELATIVE_DIR "contrib/relic")
endif()
if (NOT EXISTS "${BLS_VENDOR_ROOT}/${BLS_RELIC_RELATIVE_DIR}/CMakeLists.txt")
    message(FATAL_ERROR "Could not locate relic sources inside bls-signatures (tried depends/relic and contrib/relic)")
endif()
set(BLS_RELIC_SOURCE_DIR "${BLS_VENDOR_ROOT}/${BLS_RELIC_RELATIVE_DIR}")
set(BLS_RELIC_BINARY_DIR "${CMAKE_BINARY_DIR}/dashj-bls/bls-signatures/${BLS_RELIC_RELATIVE_DIR}")

add_subdirectory("bls-signatures/${BLS_RELIC_RELATIVE_DIR}")
